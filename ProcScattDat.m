function [OutDat,RawFin]=ProcScattDat(InId,Slope,Intercept,msmt,DaBounds,BinWidth)
...
% msmt = lightscattering measurement used (saheight, saarea etc...) as a string
...
figure,plot(OutDat(:,1),OutDat(:,2),'r.-',...
    'LineWidth',1,...
    'MarkerSize',5);
hold on,
