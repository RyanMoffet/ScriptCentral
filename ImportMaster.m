...
% 
% [hrneph,avneph]=averageneph(neph(:,1),neph(:,2)*(1e6),'08-Nov-2004 07:00:00','19-Nov-2004 08:00:00','1:00:00')
% 
% figure,plot(neph(:,1),neph(:,2)*1e6,hrneph,avneph)
...
% cd('C:\yaada\user\LightScattering\Calcofi\raw\SMPS\DN_Combined\DN_30min_res\')
% [smpsout{1}] = CalSMPS('Comb_30min_P1.txt');
% [smpsout{2}] = CalSMPS('Comb_30min_P2.txt');
% [smpsout{3}] = CalSMPS('Comb_30min_P3.txt');

% smpsbin{1}=SizeBin_SMPS_P1';  %% import these manually
...
smpstime{1}=DateTime_30min_P2; %% manually import these
