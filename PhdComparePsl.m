function PhdComparePsl(InIntens1,Size1,InIntens2,Size2,range,NumBin,legendstr,xmax,varargin)
...
errorbar(DistY2(:,1),DistY2(:,2),err2,err2,'b.-'),hold on,
errorbar(varargin{1}(:,1),varargin{1}(:,2),varargin{1}(:,3),varargin{1}(:,3),'g.-'),hold off,
