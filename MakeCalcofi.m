...
Pk2Dir = 'C:\USERS\Moffet\ProfessorFrink\yaada\user\LightScattering\Calcofi\pk2'; % pk2 data file directory (Pk2Dir)
...
OrigDataDir = 'C:\USERS\Moffet\ProfessorFrink\yaada\user\LightScattering\Calcofi\raw'; % this is where the pkls OR AKA PklDir
