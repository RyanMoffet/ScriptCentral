...
function [Slpe,Int,ThInt,ExpVal]=ScatterCal(InId,PslSizes,SpeedMode)
...
for counter1=1:length(intensarray)
    ...
    mymodel = fittype('a*x+b'); 
%     mymodel = fittype('a*x');
    opts = fitoptions('method','LinearLeastSquares');
    CalCurve=fit(Av(counter1,:)',TheorIntens',mymodel,opts)
    ThInt(:,counter1)=TheorIntens';
    ExpVal(:,counter1)=Av(counter1,:)'
