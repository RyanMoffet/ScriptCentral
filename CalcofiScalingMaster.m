...
figure,semilogx(crapx,crapy*1e12,'b-')
% 
...
% 
% %% TSI = 2.02363*RR+-1.55769
% CompareTemporals(thrsmps,tottest{1},thrsmps,2.02363*nephcorr1-1.55769,'RR','ATOFMS Total',1)
% figure,plot(thrsmps,nephcorr1,'b.-',thrsmps,tottest{1},'g.-')
